 ...
 * the Caesar cipher. This function takes a string and returns the string
 * ciphered with Rot13. If there are numbers or special characters included
 * in the string, they are returned as they are. Only letters from the
 * Latin/English alphabet are shifted, like in the original Rot13 "implementation".
 */
...
char *rot13(const char *src)
{
    ...
    char *result = malloc(strlen(src) + 1); // +1 for the null terminator
